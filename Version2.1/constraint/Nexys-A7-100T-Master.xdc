...
create_clock -add -name clk -period 10 -waveform {0 5}  [get_ports { clk }];
#create_generated_clock -name clk -divide_by 10000 -source [get_ports {clk_sw}] [get_pins { Cntsecond_forBolt_1/clk_sub }]
...
##Pmod Headers
##Pmod Header JA
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd }]; ##IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd  }]; ##IO_L21N_T3_DQS_A18_15 Sch=ja[2]
