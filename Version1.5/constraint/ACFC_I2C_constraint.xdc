...
#create_generated_clock -name BCLK -divide_by 83 -source [get_ports { clk }] [get_pins { BCLK }]
...
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { finish_config_input }]; ##IO_L17N_T2_A13_D29_14 Sch=sw[6]
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { MCLK_root }]; ##IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { uart_done }]; ##IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
##Pmod Headers
##Pmod Header JA
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { SDA }]; ##IO_L20N_T3_A19_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { FSYNC }]; ##IO_L21N_T3_DQS_A18_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { BCLK }]; ##IO_L21P_T3_DQS_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { MCLK }]; ##IO_L18N_T2_A23_15 Sch=ja[4]
