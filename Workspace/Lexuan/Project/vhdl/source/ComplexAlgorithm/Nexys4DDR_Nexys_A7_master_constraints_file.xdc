...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {clk_sysclk}];
create_clock -add -name sys_clk_pin -period 20800.00 -waveform {0 10400} [get_ports {clk_fsync}];
