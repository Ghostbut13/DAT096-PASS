...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL_12M xil_defaultlib.PLL_12M xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  PLL_12M -key {Behavioral:sim_1:Functional:PLL_12M} -tclbatch cmd.tcl -protoinst "protoinst_files/PLL_12M.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PLL_12M.wdb xsim.dir)
