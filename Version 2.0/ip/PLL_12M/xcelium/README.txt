...
#
# Generated by export_simulation on Wed Apr 05 10:41:38 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './PLL_12M.sh' script.

./PLL_12M.sh -reset_run
...
./PLL_12M.sh -noclean_files

For more information on the script, please type './PLL_12M.sh -help'.
